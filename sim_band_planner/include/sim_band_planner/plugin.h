...
public:
  ...
  virtual Result plan(const gridmap::AABB &local_region,
                      ...
                      const double avoid_distance); // override;

  virtual bool valid(const navigation_interface::Trajectory &trajectory,
                     const double) const override;
  virtual double cost(const navigation_interface::Trajectory &trajectory,
                      const double) const override;
