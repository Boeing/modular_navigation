...
private:
  ...
  cancelCallback(const std::shared_ptr<GoalHandleDrive> goal_handle);
  ...
  rclcpp_action::Server<autonomy_interface::action::Drive>::SharedPtr
      action_server_;
  ...
  rclcpp::Client<map_manager::srv::GetOccupancyGrid>::SharedPtr
  ...
  rclcpp::Subscription<cartographer_ros_msgs::msg::SystemState>::SharedPtr
      mapper_status_sub_;
