...
MapData::MapData(const double clamping_thres_min,
...
void MapData::resize(const unsigned int size_x, const unsigned int size_y, const double resolution, const double origin_x, const double origin_y)
{
    size_x_ = size_x;
    size_y_ = size_y;
