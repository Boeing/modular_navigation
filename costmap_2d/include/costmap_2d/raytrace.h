#ifndef COSTMAP_2D_RAYTRACE_H
#define COSTMAP_2D_RAYTRACE_H
...
//        ROS_INFO_STREAM("offset: " << offset);
        map_data_[offset] = std::max(clamping_thres_min_log_, std::min(clamping_thres_max_log_, map_data_[offset] + log_cost_));
    }
