...
#include <costmap_2d/DilationInflationPluginConfig.h>
...
class DilationInflationLayer : public Layer
{
  public:
    DilationInflationLayer();

    virtual ~DilationInflationLayer() override
    {
        deleteKernels();
        if (dsrv_)
            delete dsrv_;
  ...
  private:
    ...
    dynamic_reconfigure::Server<costmap_2d::DilationInflationPluginConfig>* dsrv_;
    ...
    void reconfigureCB(costmap_2d::DilationInflationPluginConfig& config, uint32_t level);
