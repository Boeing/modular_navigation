...
void projectDepth(std::unordered_map<uint64_t, float>& height_voxels, const float min_range, const float max_range,
                  const Eigen::Isometry3f& sensor_transform, const std::set<uint64_t>& footprint,
                  const sensor_msgs::Image::ConstPtr& msg, const image_geometry::PinholeCameraModel& camera_model,
