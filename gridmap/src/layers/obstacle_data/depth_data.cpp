...
DepthData::DepthData()
    : TopicDataSource<sensor_msgs::msg::Image>("depth"),
...
bool DepthData::isDataOk() const {
  return got_camera_info_ &&
         TopicDataSource<sensor_msgs::msg::Image>::isDataOk();
}

void DepthData::cameraInfoCallback(
...
bool DepthData::processData(const sensor_msgs::msg::Image::SharedPtr msg,
