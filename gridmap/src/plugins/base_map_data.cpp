...
PLUGINLIB_EXPORT_CLASS(gridmap::BaseMapData, gridmap::DataSource)
...
void BaseMapData::onInitialize(const XmlRpc::XmlRpcValue& parameters)
{
    ...
    const std::string map_topic =
        get_config_with_default_warn<std::string>(parameters, "map_topic", "map", XmlRpc::XmlRpcValue::TypeString);
